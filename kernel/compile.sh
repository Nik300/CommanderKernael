...
nasm -f elf32 '/home/nicho/Documenti/CommanderKernael/kernel/Sources/entry/kernel_entry.asm' -o ../compiled/kernel/kernel_entry.o
...
qemu-system-i386 -fda ../compiled/bootable/bootable.img
