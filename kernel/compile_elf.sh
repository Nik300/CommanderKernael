...
ld -melf_i386 -Ttext 0x1000 ../compiled/kernel/kernel_entry.o ../compiled/kernel/ports_cpp.o ../compiled/kernel/kernel.o ../compiled/kernel/stdio.o ../compiled/kernel/util.o ../compiled/kernel/ports.o ../compiled/kernel/interrupt.o ../compiled/kernel/idt.o ../compiled/kernel/isr.o -o ../compiled/bootable/bootable.elf
